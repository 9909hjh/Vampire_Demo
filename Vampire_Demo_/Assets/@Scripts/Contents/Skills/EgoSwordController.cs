...
public class EgoSwordController : SkillController
{
    ...
    void TurnOnPhisics(SwingType swingType, bool simulated)
    {
        for(int i = 0; i< _swingParticles.Length; i++)
            _swingParticles[i].GetComponent<Rigidbody2D>().simulated = false;
